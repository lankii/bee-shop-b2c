...
// @Success 201 {int} models.Feedback
// @Failure 403 body is empty
// @router / [post]
func (c *FeedbackController) Post() {
	var v models.Feedback
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddFeedback(&v); err == nil {
...
func (c *FeedbackController) GetOne() {
	...
	v, err := models.GetFeedbackById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *FeedbackController) GetAll() {
	...
	l, err := models.GetAllFeedback(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
