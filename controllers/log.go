...
// @Success 201 {int} models.Log
// @Failure 403 body is empty
// @router / [post]
func (c *LogController) Post() {
	var v models.Log
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddLog(&v); err == nil {
...
func (c *LogController) GetAll() {
	...
	l, err := models.GetAllLog(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *LogController) Put() {
	...
	v := models.Log{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateLogById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
